...
Original v1 scores remain intact and all checkpoints use the same v2 parser.
"""
import argparse
...
from medical_posttrain.evaluation.exam_parser_v2 import VERSION, rescore
...
INDEX = ROOT / "experiments/stage5/parser_correction_v2"
DERIVED = OUT / "rescored_v2"
...
def final_tables():
    ...
    for dataset, name in zip(EXAMS, ['cmexam_final_results_v2.json', 'cmb_final_results_v2.json']):
